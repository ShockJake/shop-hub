function addTableRow() {
    ...
    cell1.innerHTML = `<input class="form-control" readonly value="${technicalDetail}" name="technicalDetail[]"></input>`
    let cell2 = row.insertCell(1)
    cell2.innerHTML = `<input class="form-control" readOnly value="${detailDescription}" name="detailDescription[]"></input>`
